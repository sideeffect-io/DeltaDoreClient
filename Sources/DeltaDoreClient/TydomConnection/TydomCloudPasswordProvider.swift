...
public enum TydomCloudPasswordProvider {
    ...
    public static func fetchGatewayPassword(
        email: String,
        password: String,
        mac: String,
        session: URLSession
    ...
    private static func fetchGatewayPassword(
        ...
        guard let site = sitesResponse.sites.first(where: { $0.gateway?.mac == mac }),
